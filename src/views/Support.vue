          ...
          <div class="zone-grid">
            ...
            <article class="zone-card">
              <div class="zthumb" aria-hidden="true">
                <img :src="truckSame" alt="동일 권역 트럭 아이콘" />
              </div>
            ...
            <article class="zone-card">
              <div class="zthumb" aria-hidden="true">
                <img :src="truckOther" alt="타 권역 트럭 아이콘" />
              </div>
...
/* 배송 썸네일 2종 (브랜드 컬러 #3A8C88) */
const truckSame = (() => {
  const c = '#3A8C88';
  const svg = `
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 220 160'>
    <rect x='10' y='26' width='140' height='64' rx='12' fill='${c}' opacity='.12'/>
    <rect x='24' y='36' width='116' height='46' rx='10' fill='${c}'/>
    <rect x='152' y='56' width='56' height='42' rx='8' fill='#e9f3f2' stroke='${c}'/>
    <circle cx='76' cy='120' r='16' fill='#262626'/><circle cx='76' cy='120' r='6' fill='#fff'/>
    <circle cx='174' cy='120' r='16' fill='#262626'/><circle cx='174' cy='120' r='6' fill='#fff'/>
    <rect x='36' y='46' width='30' height='14' rx='3' fill='#fff' opacity='.95'/>
  </svg>`;
  return `data:image/svg+xml;utf8,${encodeURIComponent(svg)}`;
})();
const truckOther = (() => {
  const c = '#2F6F6B'; /* 살짝 딥톤으로 구분 */
  const svg = `
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 220 160'>
    <rect x='10' y='26' width='140' height='64' rx='12' fill='${c}' opacity='.12'/>
    <rect x='24' y='36' width='116' height='46' rx='10' fill='${c}'/>
    <rect x='152' y='56' width='56' height='42' rx='8' fill='#eef4f4' stroke='${c}'/>
    <circle cx='76' cy='120' r='16' fill='#262626'/><circle cx='76' cy='120' r='6' fill='#fff'/>
    <circle cx='174' cy='120' r='16' fill='#262626'/><circle cx='174' cy='120' r='6' fill='#fff'/>
    <rect x='36' y='46' width='30' height='14' rx='3' fill='#fff' opacity='.95'/>
  </svg>`;
